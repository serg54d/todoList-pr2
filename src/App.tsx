...
export type FilterValuesType = "all" | "active" | "completed" | "deleted" | "123";
...
function App() {
	...
	// function deleteAllTasks(tasks: Array<TaskType>) {
	// 	let deletedTasks = tasks.filter(task => task)
	// 	setFilter(deletedTasks)
	// }
